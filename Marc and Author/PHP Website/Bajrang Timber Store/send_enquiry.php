...
if(isset($_REQUEST['submit'])){
    ...
    if($full_response->status == '200'){
      ...
      echo '<script>window.location.href="http://localhost/bajrang/products.php";</script>';
        // echo '<script>window.location.href="https://rajlaxmifashion.com/product.php";</script>';
    }
    else{
