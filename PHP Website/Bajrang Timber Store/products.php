                            ...
                            <div class="Description_section">
                                ...
                                <form method="post" action="http://localhost/bajrang/send_enquiry.php">
                                    ...
                                    <div class="text-end mt-3">
                                        <button type="submit" class="btn btn__primary" name="submit">Send
                                            Enquiry</button>
                                    </div>
                                </form>
                            </div>
...
<script>
    $(document).ready(function() {
                ...
                success: function(result) {
                    ...
                    $.each(obj.products, function(i, val) {
                        ...
                        $.each(val.attributes, function(j, atr) {
                            attrs += atr.attribute.name + '|' + atr
                                .field_value + ':';
                        });
                        product_html +=
                            '<div class="col-sm-6 col-md-4 col-lg-4"><div class="project-item product_modal mt-4" data-bs-toggle="modal" data-bs-target="#product" data-pro_id="' +
                            val.id + '" data-unit_id="' + val.unit + '" data-cid="' +
                            company_id + '" data-pro_name="' + val.product_name +
                            '" data-img="' + val.picture_name + '" data-attr="' +
                            attrs + '" data-price="' + val.price + '" data-state="' +
                            val.states.state_name + '" data-color="' + val.color +
                            '" data-package="' + val.packaging_type + '" data-moq="' +
                            val.minimum_order_quantity + '" data-usage="' + val.usage +
                            '" data-unit="' + val.units.name + '" data-product_type="' +
                            val.product_type +
                            '"><div class="project__img"><img src="https://bulkvyapar.com/public/images/company/' +
                            company_id + '/product/watermark_imgs/' + val.picture_name +
                            '" alt="project img"></div><div class="project__content"><h4 class="project__title fs-5 fw-bolder mt-3"><a href="#">' +
                            val.product_name + '</a></h4></div></div></div>';
                    });
        ...
        $(document).on('click', '.product_modal', function() {
            ...
            $("#pro_img").attr("src", 'https://bulkvyapar.com/public/images/company/' + cid +
                '/product/watermark_imgs/' + img);
        });
